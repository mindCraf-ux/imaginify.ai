...
const Testimonials = () => {
  return (
    <div className='flex flex-col items-center justify-center my-20 py-12'>
      ...
      <p className='text-gray-500 mb-12'>What Our Users Are Saying About Imagify</p>
   
   <div className='flex flex-wrap gap-6'>
    {/*importing testimonialsData from assets*/}
    {testimonialsData.map((testimonail, index) => (

<div key={index}
className='bg-white/20 p-12 rounded-lg shadow=md order w-80 m-auto
cursor-pointer hover:scale-[1.02] transiton-all'>
